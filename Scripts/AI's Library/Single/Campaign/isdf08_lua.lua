...
-- Mission Name
local m_MissionName = _BZCCDatabase.Missions.ISDF08;
...
Functions[1] = function()
    ...
    Mission.m_Audioclip = _Subtitles.AudioWithSubtitles("mes0801.wav", _BZCCDatabase.SubtitlePanelSizes.SubtitlesPanelLarge);
